...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-danger">Pagos dados de baja<br>
            <small class="text-danger">Pagos quitados de la lista de aceptados.</small>
        </h1>
                ...
                <tbody>
                    @foreach ($pagos as $pago)
                        <tr>
                            ...
                            <td class="bg-warning  text-center font-weight-bold"><i
