...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Pagos rechazados<br><small class="text-danger">Lista de pagos rechazados.</small>
        </h1>
                ...
                <tbody>
                    @foreach ($pagos as $pago)
                        <tr>
                            ...
                            <td class="bg-danger text-white text-center font-weight-bold"><i
