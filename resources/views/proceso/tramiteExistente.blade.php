...
@section('contenido')
    ...
    <div class=" pt-2 mt-2">
        ...
        <div class="row">
            ...
            <form class="col-md-12 needs-validation" action="{{ route('proceso.registrar.existente') }}" method="POST"
                ...
                @foreach ($navegante as $nav)
                    @php
                        $dni = $nav->id;
                        $nombres = $nav->nombres;
                        $telefono = $nav->telefono;
                        $direccion = $nav->direccion;
                        $email = $nav->email;
                    @endphp
                @endforeach
                <div class="card mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" disabled="disabled" class="form-control" id="dni"
                                        value="{{ $dni }}" placeholder="DNI" required="">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="telefono" class="form-control" id="telefono"
                                        placeholder="923202020" required="" value="{{ $telefono }}">
                                    <div class="invalid-feedback" style="width: 100%;">
                                        Your username is required.
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="row pb-4 mb-4">
                        <div class="col-md-12 text-center">
                            ...
                            <a href="#" class="btn btn-secondary" id="cancelar">Cancelar</a>
                        </div>
                    </div>
